...
class retire_rotation2 implements Runnable{
    ...
    public void run() {
        ...
        A3_Tester2.printTree(catCafe.root, 0);
        System.out.println("\n--------------------------------------------------------------------------------------------------------");
        catCafe.retire(MrsN);
        A3_Tester2.printTree(catCafe.root, 0);
...
class retire_edgeCase7 implements Runnable {
    ...
    public void run() {
        ...
        A3_Minitester.printTree(catCafe.root, 0);
...
//TODO retire() method in this method is going properly, fix it doe this test case to work!!
