...
public class Cat implements Comparable<Cat>{
	...
	public Cat(String name, int monthHired, int furThickness, int daysToNextGrooming, double groomingCost) {
		this.name = name;
	...
	public boolean equals(Object obj) {
		return obj instanceof Cat && this.compareTo((Cat) obj) == 0 &&
				this.furThickness == ((Cat) obj).furThickness && this.name.equals(((Cat) obj).name) ;
	}
